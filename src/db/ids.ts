...
export const newIngredientsAliasId = (): IngredientsAliasId =>
    uuidv7() as IngredientsAliasId
...
export const parseRecipeStepId = (value: string): RecipeStepId | null =>
    uuidValidate(value) ? (value as RecipeStepId) : null
